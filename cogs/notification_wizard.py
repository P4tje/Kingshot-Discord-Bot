...
class CaesaresFuryConfigView(discord.ui.View):
    ...
    async def show(self, interaction: discord.Interaction):
        ...
        next_date = calculate_next_occurrence("Caesares Fury", guild_id=self.session.guild_id)
        ...
        try:
            ...
            for event_name in self.session.selected_events:
                ...
                if event_name == "Bear Trap":
                    ...
                    next_tuesday, next_thursday = calculate_viking_vengeance_dates(now, guild_id=self.session.guild_id)
